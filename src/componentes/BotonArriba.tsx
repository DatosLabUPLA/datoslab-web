...
const BotonArriba: React.FC = () => (
  <a
    href="#top"
    className="fixed bottom-4 right-4 flex items-center bg-transparent border border-white text-white hover:bg-primary hover:text-black transition-all backdrop-blur-lg p-2 rounded-lg"
  ...
  >
    <nav className="grid grid-flow-col gap-4 mt-4">
          ...
          <a href="https://www.youtube.com/@datoslabupla" target="_blank" rel="noopener noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-6 w-6 fill-current">
              <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816V175.2l8 3.993-8 4.007z" />
            </svg>
          </a>
          {/* GitHub */}
