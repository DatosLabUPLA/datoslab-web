...
const Contacto: React.FC = () => {
  return (
    <section
      id="contacto"
      className="w-full bg-customOrange text-white py-16 px-6 shadow-lg"
    >
      <div className="max-w-3xl mx-auto space-y-8 text-center">
        ...
        <div className="space-y-4">
          {/* Teléfono */}
          <p className="text-base md:text-lg flex justify-center items-center gap-3 text-black">
            <svg
